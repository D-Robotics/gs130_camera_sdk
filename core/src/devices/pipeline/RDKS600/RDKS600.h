/**
 * @file RDKS600.h
 * @brief RDK S600 node helpers: one C function per pipeline stage, plus teardown.
 *
 * Internal header of the RDK S600 backend, included by RDKS600.cpp and the node .c files
 ...
 */
#ifndef GS130_PIPELINE_RDKS600_H
#define GS130_PIPELINE_RDKS600_H
...
/**
 * @brief Marker value the S600 driver expects in every magicNumber field.
 *
 ...
 */
#define GS130_S600_MAGIC_NUMBER 0x12345678u
...
#endif /* GS130_PIPELINE_RDKS600_H */
